...
export function ContagionCacheScreen({ state, actions, onBack }: Props) {
  ...
  const [pendingTier, setPendingTier] = useState<CacheBoxTier | null>(null);
  ...
  const handleAdButtonClick = (tier: CacheBoxTier) => {
    if (opening) return;
    setPendingTier(tier);
    setShowAdModal(true);
  };
  ...
  return (
    <div className="min-h-screen bg-black text-white p-4">
              ...
              <div className="pb-2 text-center">
                {box.freeDaily ? (
                  <div className="space-y-2">
                    ...
                    {isAdClaimAvailable ? (
                      <button
                        onClick={() => handleAdButtonClick(tier)}
                        disabled={!!opening || showAdModal}
                  ...
                  <button
                    ...
                    disabled={!canOpen || !!opening || showAdModal}
      ...
      <AdModal
        ...
        title="Unlock Contagion Cache"
        subtitle="Watch a short video to open your box"
