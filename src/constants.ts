...
export const SYMBOLS: Record<SymbolId, SlotSymbol & { image?: string }> = {
  ...
  beaker:  { id: 'beaker',  emoji: '🧪', label: 'Cauldron',      pays: [4, 10, 30],   weight: 10,  image: `${SYMBOL_IMAGE_PATH}symbol-toxic-cauldron.png?v=11` },
  vomit:   { id: 'vomit',   emoji: '🤮', label: 'Slime Guy',     pays: [5, 12, 37],   weight: 8,   image: `${SYMBOL_IMAGE_PATH}symbol-slime-guy.png?v=11` },
  toxic:   { id: 'toxic',   emoji: '☢️', label: 'Radiation',     pays: [6, 16, 48],   weight: 6,   image: `${SYMBOL_IMAGE_PATH}symbol-radiation-sign.png?v=11` },
  barrel:  { id: 'barrel',  emoji: '🛢️', label: 'Waste Drum',     pays: [7, 20, 64],   weight: 4,   image: `${SYMBOL_IMAGE_PATH}symbol-waste-drum.png?v=11` },
  warn:    { id: 'warn',    emoji: '⚠️', label: 'Skull',         pays: [12, 35, 130], weight: 2.5, image: `${SYMBOL_IMAGE_PATH}symbol-radioactive-skull.png?v=11` },
