...
export const SYMBOLS: Record<SymbolId, any> = {
  ...
  gasmask: { id: 'gasmask', emoji: '😷', label: 'Gas Mask', pays: [2, 5, 13], weight: 21, image: `${SYMBOL_IMAGE_PATH}symbol-gas-mask.png` },
  beetle: { id: 'beetle', emoji: '🪲', label: 'Mutant Beetle', pays: [3, 6, 16], weight: 18, image: `${SYMBOL_IMAGE_PATH}symbol-mutant-beetle.png` },
  rat: { id: 'rat', emoji: '🐀', label: 'Mutant Rat', pays: [3, 7, 19], weight: 15, image: `${SYMBOL_IMAGE_PATH}symbol-mutant-rat.png` },
