...
export const SYMBOLS: Record<SymbolId, SlotSymbol & { image?: string }> = {
  cashlab: { id: 'cashlab', emoji: '🤑', label: 'Cash Lab',      pays: [12, 35, 130], weight: 2.5, image: `${SYMBOL_IMAGE_PATH}symbol-cash-lab.png?v=10` },
  puke:    { id: 'puke',    emoji: '🤢', label: 'Puke Town',     pays: [2, 3, 9],     weight: 26,  image: `${SYMBOL_IMAGE_PATH}symbol-puke-town.png?v=10` },
  slime:   { id: 'slime',   emoji: '🟡', label: 'Slime Blob',    pays: [2, 4, 11],    weight: 24,  image: `${SYMBOL_IMAGE_PATH}symbol-slime-blob.png?v=10` },
  sneeze:  { id: 'sneeze',  emoji: '😷', label: 'Gas Mask',      pays: [2, 5, 13],    weight: 21,  image: `${SYMBOL_IMAGE_PATH}symbol-gas-mask.png?v=10` },
  tp:      { id: 'tp',      emoji: '🐀', label: 'Mutant Rat',    pays: [3, 6, 16],    weight: 18,  image: `${SYMBOL_IMAGE_PATH}symbol-mutant-rat.png?v=10` },
  pill:    { id: 'pill',    emoji: '💊', label: 'Test Tube',     pays: [3, 7, 19],    weight: 15,  image: `${SYMBOL_IMAGE_PATH}symbol-test-tube.png?v=10` },
  germ:    { id: 'germ',    emoji: '🦠', label: 'Virus',         pays: [3, 8, 23],    weight: 13,  image: `${SYMBOL_IMAGE_PATH}symbol-virus.png?v=10` },
  beaker:  { id: 'beaker',  emoji: '🧪', label: 'Cauldron',      pays: [4, 10, 30],   weight: 10,  image: `${SYMBOL_IMAGE_PATH}symbol-toxic-cauldron.png?v=10` },
  vomit:   { id: 'vomit',   emoji: '🤮', label: 'Slime Guy',     pays: [5, 12, 37],   weight: 8,   image: `${SYMBOL_IMAGE_PATH}symbol-slime-guy.png?v=10` },
  toxic:   { id: 'toxic',   emoji: '☢️', label: 'Radiation',     pays: [6, 16, 48],   weight: 6,   image: `${SYMBOL_IMAGE_PATH}symbol-radiation-sign.png?v=10` },
  barrel:  { id: 'barrel',  emoji: '🛢️', label: 'Waste Drum',     pays: [7, 20, 64],   weight: 4,   image: `${SYMBOL_IMAGE_PATH}symbol-waste-drum.png?v=10` },
  warn:    { id: 'warn',    emoji: '⚠️', label: 'Skull',         pays: [12, 35, 130], weight: 2.5, image: `${SYMBOL_IMAGE_PATH}symbol-radioactive-skull.png?v=10` },
  rich:    { id: 'rich',    emoji: '📻', label: 'Geiger Counter', pays: [18, 55, 220],  weight: 1.5, image: `${SYMBOL_IMAGE_PATH}symbol-geiger-counter.png?v=10` },
  wild:    { id: 'wild',    emoji: '🤮', label: 'Puke Wild',     pays: [0, 0, 0], weight: 3.5, special: 'wild', isSpecial: true, image: `${SYMBOL_IMAGE_PATH}symbol-wild.png?v=10` },
  scatter: { id: 'scatter', emoji: '🤒', label: 'Sick Scatter',   pays: [0, 0, 0], weight: 2, special: 'scatter', isSpecial: true, image: `${SYMBOL_IMAGE_PATH}symbol-scatter.png?v=10` },
  bonus:   { id: 'bonus',   emoji: '☢️', label: 'Toxic Bonus',    pays: [0, 0, 0], weight: 1.5, special: 'bonus', isSpecial: true, image: `${SYMBOL_IMAGE_PATH}symbol-bonus.png?v=10` },
  hazard:  { id: 'hazard',  emoji: '☣️', label: 'Hazard Mystery', pays: [0, 0, 0], weight: 1.2, special: 'hazard', isSpecial: true, image: `${SYMBOL_IMAGE_PATH}symbol-hazard.png?v=10` },
  jackpot: { id: 'jackpot', emoji: '🧪', label: 'Toxic Jackpot',  pays: [0, 0, 0], weight: 1, special: 'jackpot', isSpecial: true, image: `${SYMBOL_IMAGE_PATH}symbol-jackpot.png?v=10` },
};
